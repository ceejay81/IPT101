...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO events (name, date, time, venue, description, expiration_date, teacher_id) VALUES ('$name', '$date', '$time', '$venue', '$description', '$expiration_date', '$teacher_id')";
